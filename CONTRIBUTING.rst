Contributing to MaterialsCoord
====================================
...
MaterialsCoord is still in development, so at the moment we
do not have a dedicated help forum. For the time being, please
submit questions and bugs to the pymatgen
`Discourse forum <http://pymatgen.discourse.group>`__.
...
contributors `here
<https://github.com/hackingmaterials/materials-coord/blob/master/CONTRIBUTORS.rst>`__.
